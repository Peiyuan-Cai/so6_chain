...
if __name__ == "__main__":
    ...
    import os
    homepath = os.getcwd()
    path = homepath #save the MPOMPS states directly in the home path
    ...
    fname = os.path.join(homepath, 'so4psimpos_lx{}_1'.format(lx))
    ...
    fname = os.path.join(homepath, 'so4psimpos_lx{}_2'.format(lx))
    with open(fname, 'wb') as f:
