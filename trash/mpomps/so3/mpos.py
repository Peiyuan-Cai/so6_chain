...
if __name__ == "__main__":
    ...
    print("----------Spin5/2 model DMRG---------")
    model_params = dict(Lx = lx, pbc=pbc, J=J, K=K, D=216, sweeps=6, verbose=2)
    spin5halfdmrgmodel = Spin5HalfJK(model_params)
    phidmrg, Edmrg = spin5halfdmrgmodel.run_dmrg()
    print("Spin5/2 DMRG results")
    print("phi after DMRG is", phidmrg)
    print("Spin5/2 DMRG Energy is", Edmrg)
    ...
    spinmpo = spin5halfdmrgmodel.calc_H_MPO()
    print(" ")
    print("the overlap of phidmrg and gppsimlwo", phidmrg.overlap(gppsimlwo))
    print(" ")
    print("the sandwich of projected psimlwo and Spin5/2 MPO is", spinmpo.expectation_value(gppsimlwo)+Econst)