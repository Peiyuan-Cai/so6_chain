...
if __name__ == "__main__":
    ...
    vmat11, vmat22 = mpos.v11[:,0], mpos.v22[:,0]
    umat12, umat21 = mpos.u12[:,0], mpos.u21[:,0]
    vmat11.dtype = np.complex64; vmat22.dtype = np.complex64
    umat21.dtype = np.complex64; umat12.dtype = np.complex64
    vmat11[0] = 1j/np.sqrt(2); vmat11[1:] = 0; vmat11[-1] = 1/np.sqrt(2)
    umat21[0] = 1j/np.sqrt(2); umat21[1:] = 0; umat21[-1] = -1/np.sqrt(2)
    print('vmat11',vmat11)
    print('umat21',umat21)
    boundary_mpo = mpos.get_mpo_U1(vmat11, vmat22, umat12, umat21, 3)
