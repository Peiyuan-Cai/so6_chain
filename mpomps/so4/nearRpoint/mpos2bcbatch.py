...
if __name__ == "__main__":
    ...
    lambda_list = np.arange(1.8, 2.0, 0.02)
    lambda_list = np.round(lambda_list, 2)
    ...
    for lamb in lambda_list:
        ...
        fname = os.path.join(path, 'so4psimpos_lx{}_delta{}_lambda{}_Dmpos{}_APBC'.format(lx, delta, lamb, Dmpos))
        ...
        fname = os.path.join(path, 'so4psimpos_lx{}_delta{}_lambda{}_Dmpos{}_PBC'.format(lx, delta, lamb, Dmpos))
        with open(fname, 'wb') as f:
